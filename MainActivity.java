...
import androidx.appcompat.app.AppCompatDelegate; // Import for dark mode
...
import com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton; // Import ExtendedFloatingActionButton
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int REQUEST_CODE_PICK_ZIP_FILE = 103; // Request code for picking zip file
    private static final String PREFS_NAME = "project_prefs";
    private static final String PROJECTS_LIST_KEY = "projects_list";
    private static final String CHAT_HISTORY_FILE_NAME = "chat_history.json"; // Name for exported chat history file
    ...
    private ExtendedFloatingActionButton fabCreateProject;
    private ExtendedFloatingActionButton fabImportProject;
    private ConstraintLayout fabSpeedDialContainer; // Container for all FABs
    private boolean isFabMenuOpen = false; // To track FAB menu state
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(R.style.AppTheme_DarkOnly);
        ...
        fabCreateProject = findViewById(R.id.fab_new_project_extended);
        fabImportProject = findViewById(R.id.fab_import_project);
        fabSpeedDialContainer = findViewById(R.id.fab_speed_dial_container);

        setSupportActionBar(toolbar);
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("CodeX Projects");
        }
    ...
    private void toggleFabMenu() {
        if (isFabMenuOpen) {
            ...
            fabImportProject.hide();
            fabMain.setImageResource(R.drawable.ic_add); // Change icon to add
        } else {
            fabCreateProject.show();
            fabImportProject.show();
            fabMain.setImageResource(R.drawable.ic_close); // Change icon to close
        }
    ...
    private void loadProjectsList() {
        ...
        if (loadedList != null) {
            ...
            Collections.sort(projectsList, (p1, p2) -> {
                long date1 = (long) p1.getOrDefault("lastModifiedTimestamp", 0L);
                long date2 = (long) p2.getOrDefault("lastModifiedTimestamp", 0L);
    ...
    private void updateEmptyStateVisibility() {
        if (projectsList.isEmpty() && hasStoragePermission()) {
            ...
            textEmptyProjects.setText("No projects yet. Create your first project!");
