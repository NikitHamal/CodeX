...
public class OIVSCodeSer2ApiClient extends AnyProviderApiClient {
    private static final String API_ENDPOINT = "https://oi-vscode-server-2.onrender.com/v1/chat/completions";
    private final Random random = new Random();

    public OIVSCodeSer2ApiClient(Context context, AIAssistant.AIActionListener actionListener) {
